...
software=tk.Tk()
software.geometry('1200x800')
software.title("Tushar_DRD's_Editor")
software.wm_iconbitmap('icon.ico')
...
align_center_button=ttk.Button(tool_bar,image=align_left_icon)
...
text_editor=tk.Text(software)
text_editor.config(wrap='word',relief=tk.FLAT)
scroll_bar=tk.Scrollbar(software)
...
#font famili and font size functionality:
...
text_editor.configure(font=('Arial',12))                      #bydefault type 
...
status_bar=ttk.Label(software,text='Status Bar')
...
def open_file(event=None):
    ...
    try:
        ...
        return 
    software.title(os.path.basename(url))
...
file.add_command(label='SaveAS',image=save_as_icon,compound=tk.LEFT,accelerator='Ctrl+Alt+S',command=save_as)
...
edit.add_command(label='ClearAll',image=clear_all_icon,compound=tk.LEFT,accelerator='Ctrl+Alt+X',command=lambda:text_editor.delete(1.0,tk.END))
...
software.config(menu=main_menu)

#### bind shortcut keys 
software.bind("<Control-n>", new_file)
software.bind("<Control-o>", open_file)
software.bind("<Control-s>", save_file)
software.bind("<Control-Alt-s>", save_as)
software.bind("<Control-q>", exit_func)
software.bind("<Control-f>", find_func)
